  ...
  return (
    <section className="flex min-h-screen flex-col items-center justify-center px-4 pt-20 text-center">
      ...
      >
        ...
        >
          <a href="mailto:shamkarthik88@gmail.com" className="text-secondary hover:text-neon-blue transition-colors inline-flex items-center gap-1.5">
            <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            shamkarthik88@gmail.com
          </a>
          <span className="text-muted hidden sm:inline">·</span>
          <a href="https://medium.com/@shamkarthik88" target="_blank" rel="noopener noreferrer" className="text-secondary hover:text-neon-blue transition-colors inline-flex items-center gap-1.5">
            <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M0 0v24h24V0H0zm19.938 5.686L18.651 6.92a.376.376 0 00-.143.362v9.067a.376.376 0 00.143.362l1.257 1.234v.271h-6.322v-.27l1.302-1.265c.128-.128.128-.165.128-.361V8.99l-3.62 9.195h-.49L6.69 8.99v6.163a.85.85 0 00.234.707l1.694 2.054v.271H3.815v-.27l1.694-2.054a.82.82 0 00.234-.707V8.075a.624.624 0 00-.203-.532L4.025 5.686v-.27h4.674l3.613 7.923 3.176-7.924h4.456l-.006.271z"/></svg>
            Medium
          </a>
        </motion.div>
      </motion.div>
